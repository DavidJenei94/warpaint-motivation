...
class WarpaintMotivationView extends WatchUi.WatchFace {
    ...
    function onUpdate(dc as Dc) as Void {
		...
		if (_burnInProtection && !_isAwake) {
			...
			if (uatLogOnUpdateEllapsedTime) {
				currentTime = System.getTimer();
				System.println("setSettingsAndSetBurnInProtection Ellapsed time: " + (currentTime - startTime) + " ms");
				startTime = System.getTimer();
			}
			...
			if (uatLogOnUpdateEllapsedTime) {
				currentTime = System.getTimer();
				System.println("checkSunriseSunsetRefresh Ellapsed time: " + (currentTime - startTime) + " ms");
				startTime = System.getTimer();
			}
			...
			if (uatLogOnUpdateEllapsedTime) {
				currentTime = System.getTimer();
				System.println("Set data for data fields Ellapsed time: " + (currentTime - startTime) + " ms");
				startTime = System.getTimer();
			}
			...
			if (uatLogOnUpdateEllapsedTime) {
				currentTime = System.getTimer();
				System.println("Set data for databars Ellapsed time: " + (currentTime - startTime) + " ms");
				startTime = System.getTimer();
			}
			...
			if (uatLogOnUpdateEllapsedTime) {
				currentTime = System.getTimer();
				System.println("checkMotivationRefreshAndSplit Ellapsed time: " + (currentTime - startTime) + " ms");
				startTime = System.getTimer();
			}
			...
			if (uatLogOnUpdateEllapsedTime) {
				currentTime = System.getTimer();
				System.println("draw layout with View.onUpdate Ellapsed time: " + (currentTime - startTime) + " ms");
				startTime = System.getTimer();
			}
