...
class WarpaintMotivationView extends WatchUi.WatchFace {
	...
	private function selectBasicTheme() as Void {
	...
	private function selectStandardTheme() as Void {
	...
	private function selectExtraTheme() as Void {
	...
	private function setFixedColors() as Void {
		if (theme % 5 == 0) {
			themeColors[:backgroundColor] = 0x000000;
		} else if (theme % 5 == 1) {
			themeColors[:backgroundColor] = 0xFFFFFF;
