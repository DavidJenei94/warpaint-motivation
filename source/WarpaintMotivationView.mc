    ...
    function onUpdate(dc as Dc) as Void {
		...
		if (_burnInProtection && !_isAwake) {
			...
			if (uatLogOnUpdateEllapsedTime) {
				...
				System.println("loadDrawables Ellapsed time: " + (currentTime - startTime) + " ms");
			...
			if (uatLogOnUpdateEllapsedTime) {
				currentTime = System.getTimer();
				System.println("Set settings Ellapsed time: " + (currentTime - startTime) + " ms");
				startTime = System.getTimer();
			}
			...
			if (uatLogOnUpdateEllapsedTime) {
				currentTime = System.getTimer();
				System.println("Refresh data Ellapsed time: " + (currentTime - startTime) + " ms");
				startTime = System.getTimer();
			}
			...
			if (uatLogOnUpdateEllapsedTime) {
				currentTime = System.getTimer();
				System.println("Sunrise sunset check Ellapsed time: " + (currentTime - startTime) + " ms");
				startTime = System.getTimer();
			}
			...
			if (uatLogOnUpdateEllapsedTime) {
				currentTime = System.getTimer();
				System.println("Data field Selection Ellapsed time: " + (currentTime - startTime) + " ms");
				startTime = System.getTimer();
			}
			...
			if (uatLogOnUpdateEllapsedTime) {
				currentTime = System.getTimer();
				System.println("Databar selection Ellapsed time: " + (currentTime - startTime) + " ms");
				startTime = System.getTimer();
			}
			...
			if (uatLogOnUpdateEllapsedTime) {
				currentTime = System.getTimer();
				System.println("Motivational quote selection Ellapsed time: " + (currentTime - startTime) + " ms");
				startTime = System.getTimer();
			}
			...
			if (uatLogOnUpdateEllapsedTime) {
				currentTime = System.getTimer();
				System.println("Draw Time (+AM/PM), date, data fields, databars, Motivational quote Ellapsed time: " + (currentTime - startTime) + " ms");
				startTime = System.getTimer();
			}
